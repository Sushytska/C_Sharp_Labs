...
namespace Laba2
{
    public class ResearchTeam : Team, INameAndCopy
    {
        ...
        public override string ToString()
        {
            ...
            return $"TopicResearch: {_TopicResearch} NameOrganization: {Name} RegisterNumber: {RegisterNumberOfTeam} TimeResearche: {_TimeResearche} Papers: {stringBuilder1} MemberPapers: {stringBuilder2}";
        }

        public virtual string ToShortString()
        {
            return $"TopicResearch: {_TopicResearch} NameOrganization: {Name} RegisterNumber: {RegisterNumberOfTeam} TimeResearche: {_TimeResearche}";
        }
